    ...
    return (
      <div className="tab-panel">
        <EditSection
          title="Invoice"
          fields={[
            { label: 'Address Type',   value: admin.invoiceAddressType,    onChange: ch('invoiceAddressType') },
        ...
        <EditSection
          title="Shipping"
          fields={[
            { label: 'Address Type',         value: admin.shippingAddressType,         onChange: ch('shippingAddressType') },
